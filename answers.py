...
class Solution:
    ...
    def mergeSort(self, unsorted_list: list[int]) -> list[int]:
        ...
        l, r = self.mergeSort(unsorted_list[:mid]), self.mergeSort(unsorted_list[mid:])
        pa = pb = 0
        res = []
    ...
    def uniquePaths(self, m: int, n: int) -> int:
        def dfs(down, right, memo):
            ...
            memo[(down, right)] = dfs(down - 1, right, memo) + dfs(
                down, right - 1, memo
            )
        ...
        def neighbors(pos, start):
            ...
            for row, col in dir:
                ...
                if (
                    ...
                    copy[row_offset][col_offset], copy[r][c] = (
                        copy[r][c],
                        copy[row_offset][col_offset],
                    )
                    yield copy
